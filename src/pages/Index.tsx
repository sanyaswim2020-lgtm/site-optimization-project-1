              ...
              <CardContent className="p-6 space-y-4">
                ...
                <div className="mt-6">
                  ...
                  <div className="bg-white p-4 rounded-lg border border-green-200 space-y-3">
                    ...
                    <p className="text-sm">У этих атомов внешним является один и тот же энергетический уровень (4-й уровень), и <span className="bg-yellow-200 px-1 rounded">на нём у всех атомов одинаковое количество электронов (1е на 4s-подуровне)</span>. У <strong>K, Cr, Cu одинаковые конфигурации внешнего электронного слоя</strong> (уровня). <strong>Электронный слой и энергетический уровень - это синонимы</strong>.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
